...
describe('ideas promt generator', () => {
	it('creates the correct prompt with the keyword love', () => {
		...
		const expectedPromt =
			'Generate 5 topic ideas for social media posts using the keywords "love".';
	...
	it('creates the correct prompt with the keywords programming, javascript, node', () => {
		...
		const expectedPromt =
			'Generate 5 topic ideas for social media posts using the keywords "programming", "javascript", "node".';
...
describe('post promt generator', () => {
	it('creates the correct prompt for a tweet', () => {
		...
		const expectedPromt =
			'Write a tweet using a Neutral tone about "How to become a better programmer".';
	...
	it('creates the correct prompt for an Instagram post', () => {
		...
		const expectedPromt =
			'Write a Instagram post using a Formal tone about "How to become a better programmer".';
